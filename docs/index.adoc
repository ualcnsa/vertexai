...
:keywords: VertexAI LangChain Servicios Aplicaciones Express NodeJS
:doctype: book
:icons: font
...
:page-component-display-version: 0.24.0
...
:imagesdir: modules/{section}/images
include::{sectionPath}/index.adoc[]
include::{sectionPath}/gcp-vertexai.adoc[leveloffset=+1]
